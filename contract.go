...
func DeployContract(auth *bind.TransactOpts, backend bind.ContractBackend, _requestor common.Address, _size *big.Int, _name string, _numApprovers *big.Int, _reqApprovers [5]*big.Int) (common.Address, *types.Transaction, *Contract, error) {
